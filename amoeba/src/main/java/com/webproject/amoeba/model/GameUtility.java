...
public class GameUtility {
    ...
    List<Point> points; //TODO vagz inkabb valamilzen pointDTO kellene
    ...
    public GameUtility(int tableDimensionY, int tableDimensionX) {
        // TODO adatbayisbol betolteni a point listet aytan attolteni ay erteketet a kulonboyo listakba
